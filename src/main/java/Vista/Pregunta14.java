...
//Se define una proiedad de tipo juego con el nombre controlador
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html>¿La palabra Private en <br/> programación se le denomina?");

        Opcion1.setFont(new java.awt.Font("Traditional Arabic", 0, 18)); // NOI18N
        Opcion1.setText("A. Modificador de acceso no privado");
        ...
        Opcion2.setText("B. Modificador de acceso privado");
        ...
        Opcion3.setText("C. Modificador de acceso númerico");
        ...
        Opcion4.setText("D. Modificador de acceso de texto");
