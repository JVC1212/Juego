...
//Se define una proiedad de tipo juego con el nombre controlador
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿Qué es Pseudocódigo?");

        Opcion1.setFont(new java.awt.Font("Traditional Arabic", 0, 18)); // NOI18N
        Opcion1.setText("A. Código final que va a ejecutar el programa");
        ...
        Opcion2.setText("B. Programa que ejecuta el codigo compilado");
        ...
        Opcion3.setText("C. Forma de expresar el lenguaje de la máquina");
        ...
        Opcion4.setText("<html>D. Forma de expresar los distintos pasos que va a realizar un programa <br/> de la forma mas parecia a un lenguaje de programación");
