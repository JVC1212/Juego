...
public class Pregunta5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿Qué es un compilador?");

        Opcion1.setFont(new java.awt.Font("Traditional Arabic", 0, 18)); // NOI18N
        Opcion1.setText("<html>A. Hardware que traduce un programa escrito en un lenguaje<br/> de programación al lenguaje máquina");
        ...
        Opcion2.setText("B. Software para traducir el codigo fuente a una nube");
        ...
        Opcion3.setText("<html>C. Software que permite pasar el lenguaje de la maquina<br/>  a código fuente");
        ...
        Opcion4.setText("<html>D. Software que traduce un programa escrito en un lenguaje<br/> de programación al lenguaje máquina");
