...
//Se define una proiedad de tipo juego con el nombre controlador
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿Qué es un lenguaje de programación?");

        Opcion1.setFont(new java.awt.Font("Traditional Arabic", 0, 18)); // NOI18N
        Opcion1.setText("A.  Lenguaje que se usa para escribir binarios");
        ...
        Opcion2.setText("<html>B. Lenguaje para organizar algoritmos y procesos logicos<br/>\nque permite interactuar al ser humano con la computadora");
        ...
        Opcion3.setText("<html>C. Lenguaje para organizar algoritmos y procesos logicos<br/> que no permite interactuar al ser humano con la computadora");
